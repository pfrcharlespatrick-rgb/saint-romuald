> **Document d'archive.** Brief du transfert initial vers Claude Code ; le
> transfert est accompli et l'état du projet décrit ici est dépassé. Pour
> l'orientation à jour, voir `CLAUDE.md` à la racine.
